...
PDP:[kod_zwrotny]
Jeżeli serwer ogłosił gotowość do otrzymania pakietu, klient wysyła
go w formie binarnej bądź heksadecymalnej.
[pakiet]
...
Protokół nie określa również protokołów zawartych w pakiecie. Serwer
analizując kolejne bajty powinien wywnioskować jaki protokół znajduje
się na wyższej warstwie modelu sieciowego.
======================================================================